...
schema = Schema((
	...
	LinesField(
		...
		widget=LinesWidget(
			...
			description="List each review state (e.g., 'published','external',etc.) that you wish to be displayed in your CalendarX.  These states will be appended to the list of any other review state choices you've made using other attributes.",
			i18n_domain="CalendarX"
		),
		schemata="Calendar Options",
	),	
